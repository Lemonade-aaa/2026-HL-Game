...
while guess!= secret and guesses_used < guesses_allowed:
    ...
    if guess in already_guessed:
        print(f"You have already guessed {guess}. You've still have"
    ...
    #options (lucky / phew / well done)
        ...
        if guesses_used == 1:
            ...
            feedback = f"damn, got it in {guesses_used}"

        else:
            feedback = f"NOICE, you got it in {guesses_used} guesses"

    # if there are no guesses left
    else:
        feedback = "Aw shucks, you ran outta guesses"
